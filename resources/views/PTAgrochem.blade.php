...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1>Welcome to <a href="/" class="logo">PT. Agrochem Company</a></h1>
            <h2>We Are Part Of <h1 class="logo"><a href="index.html"><img src="assets/img/AGROFARM EKSTERNAL.png"></a></h1>
            </h2>
            <div class="d-flex">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <ul id="portfolio-flters">
                            ...
                            <li data-filter=".filter-app">Fertilizer</li>
                            <li data-filter=".filter-card">Grain</li>
                            <li data-filter=".filter-web">Rice</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <img src="assets/img/Product/ANR-30.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Fertilizer 1</h4>
                            <p>ANR-30</p>
                            <a href="assets/img/Product/ANR-30.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="ANR-30"><i class="bx bx-plus"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <img src="assets/img/Product/BOP-8.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Fertilizer 2</h4>
                            <p>BOP-8</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <img src="assets/img/Product/PALMIC.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Fertilizer 3</h4>
                            <p>PALMIC</p>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                        <div class="member">
                            ...
                            <div class="member-info">
                                ...
                                <span>Certified Risk Management Officer</span>
                            </div>
                        </div>
                    </div>
