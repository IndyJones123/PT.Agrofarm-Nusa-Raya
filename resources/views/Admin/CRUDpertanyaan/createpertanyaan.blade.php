                            ...
                            <form action="/TablePertanyaan/create/store" method="POST">
                                ...
                                <table class="mx-auto text-center">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <textarea required="" type="text" name="pertanyaan" autocomplete="off" class="input"></textarea>
                                                <label class="user-label">Pertanyaan</label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                <textarea required="" type="text" name="jawaban" autocomplete="off" class="input"></textarea>
