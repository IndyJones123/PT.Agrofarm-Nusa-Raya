                            ...
                            <form action="/TableProducts/create/store" method="POST">
                                ...
                                <table class="mx-auto text-center">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input required="" type="text" name="namaproducts" autocomplete="off" class="input"></input>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input required="" type="date" name="tanggalterbit" autocomplete="off" class="input"></input>
